...
#sed -i "s/^listen = .*/listen = \\/run\\/php-fpm.sock/g" /etc/opt/remi/php${PHP_VERSION}/php-fpm.d/www.conf
...
sed -i "s/^;cgi.fix_pathinfo.*/cgi.fix_pathinfo=0/g" /etc/opt/remi/php${PHP_VERSION}/php.ini
